...
class DataManager(object):
    def __init__(
        ...
        # add the last increment if exists
    ...
    def get_task_size(self, task):
        # Return the number of classes in a given task.
        return self._increments[task]
    
    def get_accumulate_tasksize(self,task):
        # Return the number of classes that has been see
    ...
    def get_dataset(
        ...
        r"""
        Args:
            indices: list of class indices to be selected.
            source: train or test.
            mode: train test or flip.
            appendent: extra data to be appended, usually the exemplars memory.
            ret_data: whether to return the data and targets.
            m_rate: RMM related argument.
            """
        if source == "train":
    ...
    def _setup_data(self, dataset_name, shuffle, seed):
        ...
        idata = _get_idata(dataset_name, self.data_root, self.download)
        idata.download_data()
...
def _get_idata(dataset_name, data_root="./data", download=True):
    name = dataset_name.lower()
    if name == "cifar10":
        return iCIFAR10(data_root, download)
    elif name == "cifar100":
        return iCIFAR100(data_root, download)
    elif name == "imagenet1000":
        return iImageNet1000(data_root, download)
    elif name == "imagenet100":
        return iImageNet100(data_root, download)
    elif name == "cifar100_aa":
        return iCIFAR100_AA(data_root, download)
    elif name == "cifar10_aa":
        return iCIFAR10_AA(data_root, download)
    else:
